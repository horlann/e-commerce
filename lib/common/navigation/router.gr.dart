...
import '../../presentation/pages/admin/create_category/create_category.dart' as _i11;
...
import '../../presentation/pages/admin/products_list/components/edit_item.dart' as _i15;
import '../../presentation/pages/admin/products_list/products_list.dart' as _i14;
import '../../presentation/pages/admin/products_list/products_list_wrapper.dart' as _i13;
...
class AppRouter extends _i16.RootStackRouter {
  AppRouter([_i17.GlobalKey<_i17.NavigatorState>? navigatorKey]) : super(navigatorKey);

  @override
  final Map<String, _i16.PageFactory> pagesMap = {
    MainScreen.name: (routeData) {
      return _i16.MaterialPageX<dynamic>(routeData: routeData, child: const _i1.MainScreen());
    },
    AdminRouter.name: (routeData) {
      return _i16.MaterialPageX<dynamic>(routeData: routeData, child: const _i2.AdminScreen());
    },
    HomePageWrapper.name: (routeData) {
      return _i16.MaterialPageX<dynamic>(routeData: routeData, child: const _i3.HomePageWrapper());
    },
    AccountRouter.name: (routeData) {
      return _i16.MaterialPageX<dynamic>(routeData: routeData, child: const _i4.AccountPage());
    },
    CartWrapper.name: (routeData) {
      return _i16.MaterialPageX<dynamic>(routeData: routeData, child: const _i5.ShoppingCartWrapper());
    },
    HomeRouter.name: (routeData) {
      return _i16.MaterialPageX<dynamic>(routeData: routeData, child: const _i6.HomePage());
    },
    DetailsRouter.name: (routeData) {
      final args = routeData.argsAs<DetailsRouterArgs>();
      return _i16.MaterialPageX<dynamic>(
          routeData: routeData,
          child: _i7.DetailsScreen(key: args.key, product: args.product, itemConfiguration: args.itemConfiguration));
    },
    ShoppingCartRouter.name: (routeData) {
      return _i16.MaterialPageX<dynamic>(routeData: routeData, child: const _i8.ShoppingCartPage());
    },
    OrderConfirmationRouter.name: (routeData) {
      return _i16.MaterialPageX<dynamic>(routeData: routeData, child: const _i9.OrderConfirmationPage());
    },
    CreateItemRouter.name: (routeData) {
      return _i16.MaterialPageX<dynamic>(routeData: routeData, child: const _i10.CreateItem());
    },
    CreateCategoryRouter.name: (routeData) {
      return _i16.MaterialPageX<dynamic>(routeData: routeData, child: const _i11.CreateCategory());
    },
    OrdersListRouter.name: (routeData) {
      return _i16.MaterialPageX<dynamic>(routeData: routeData, child: const _i12.OrdersList());
    },
    ProductsListWrapper.name: (routeData) {
      return _i16.MaterialPageX<dynamic>(routeData: routeData, child: const _i13.ProductsListWrapper());
    },
    ProductsListRouter.name: (routeData) {
      return _i16.MaterialPageX<dynamic>(routeData: routeData, child: const _i14.ProductsListPage());
    },
    EditItemRouter.name: (routeData) {
      final args = routeData.argsAs<EditItemRouterArgs>();
      return _i16.MaterialPageX<dynamic>(routeData: routeData, child: _i15.EditItem(key: args.key, item: args.item));
    }
  };
  ...
  List<_i16.RouteConfig> get routes => [
        _i16.RouteConfig(MainScreen.name, path: '/', children: [
          ...
          _i16.RouteConfig(HomePageWrapper.name, path: 'homePageWrapper', parent: MainScreen.name, children: [
            _i16.RouteConfig(HomeRouter.name, path: '', parent: HomePageWrapper.name),
            _i16.RouteConfig(DetailsRouter.name, path: 'details', parent: HomePageWrapper.name)
          ]),
          _i16.RouteConfig(AccountRouter.name, path: 'account', parent: MainScreen.name),
          _i16.RouteConfig(CartWrapper.name, path: 'cart', parent: MainScreen.name, children: [
            _i16.RouteConfig(ShoppingCartRouter.name, path: '', parent: CartWrapper.name),
            _i16.RouteConfig(OrderConfirmationRouter.name, path: 'order_confirmation', parent: CartWrapper.name)
          ])
        ]),
        _i16.RouteConfig(AdminRouter.name, path: '/admin', children: [
          _i16.RouteConfig('#redirect', path: '', parent: AdminRouter.name, redirectTo: 'orders_list', fullMatch: true),
          _i16.RouteConfig(CreateItemRouter.name, path: 'create_item', parent: AdminRouter.name),
          _i16.RouteConfig(CreateCategoryRouter.name, path: 'create_category', parent: AdminRouter.name),
          _i16.RouteConfig(OrdersListRouter.name, path: 'orders_list', parent: AdminRouter.name),
          _i16.RouteConfig(ProductsListWrapper.name, path: 'productsListWrapper', parent: AdminRouter.name, children: [
            _i16.RouteConfig(ProductsListRouter.name, path: '', parent: ProductsListWrapper.name),
            _i16.RouteConfig(EditItemRouter.name, path: 'edit_item', parent: ProductsListWrapper.name)
          ])
        ])
      ];
}
...
class MainScreen extends _i16.PageRouteInfo<void> {
  const MainScreen({List<_i16.PageRouteInfo>? children}) : super(MainScreen.name, path: '/', initialChildren: children);
...
class DetailsRouter extends _i16.PageRouteInfo<DetailsRouterArgs> {
  DetailsRouter({_i17.Key? key, required _i18.Item product, int itemConfiguration = -1})
      : super(DetailsRouter.name,
            path: 'details', args: DetailsRouterArgs(key: key, product: product, itemConfiguration: itemConfiguration));

  static const String name = 'DetailsRouter';
}

class DetailsRouterArgs {
  const DetailsRouterArgs({this.key, required this.product, this.itemConfiguration = -1});
...
class OrderConfirmationRouter extends _i16.PageRouteInfo<void> {
  const OrderConfirmationRouter() : super(OrderConfirmationRouter.name, path: 'order_confirmation');
...
class CreateCategoryRouter extends _i16.PageRouteInfo<void> {
  const CreateCategoryRouter() : super(CreateCategoryRouter.name, path: 'create_category');
...
class ProductsListWrapper extends _i16.PageRouteInfo<void> {
  const ProductsListWrapper({List<_i16.PageRouteInfo>? children})
      : super(ProductsListWrapper.name, path: 'productsListWrapper', initialChildren: children);
...
class EditItemRouter extends _i16.PageRouteInfo<EditItemRouterArgs> {
  EditItemRouter({_i17.Key? key, required _i18.Item item})
      : super(EditItemRouter.name, path: 'edit_item', args: EditItemRouterArgs(key: key, item: item));
