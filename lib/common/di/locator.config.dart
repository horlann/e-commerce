...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get, {String? environment, _i2.EnvironmentFilter? environmentFilter}) async {
  ...
  gh.lazySingleton<_i10.UserRemoteRepository>(() => _i10.UserRemoteRepository(get<_i7.RemoteDataSource>()));
  gh.factory<_i11.AccountBloc>(() => _i11.AccountBloc(get<_i10.UserRemoteRepository>()));
  gh.singletonAsync<_i12.IKeyValueDataSource>(
      () async => _i12.ShardsDataSource(await get.getAsync<_i9.SharedPreferences>()));
  gh.singletonAsync<_i13.LocalRepository>(
      () async => _i13.LocalRepository(await get.getAsync<_i12.IKeyValueDataSource>()));
  gh.lazySingleton<_i14.OrderingRemoteRepository>(() => _i14.OrderingRemoteRepository(get<_i7.RemoteDataSource>()));
  gh.lazySingleton<_i15.RemoteAdminRepository>(() => _i15.RemoteAdminRepository(get<_i7.RemoteDataSource>()));
  return get;
}
